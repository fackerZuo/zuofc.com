...
export default {
    ...
    data(){
        return{
            ...
            rainIcon: [
                {
                    on: oss+'/image/rain/rain_on.png',
                    off: oss+'/image/rain/rain_off.png',
                    music: oss+'/image/rain/thunder.mp3',
                    active: false
                },
                {
                    on: oss+'/image/rain/rain2_on.png',
                    off: oss+'/image/rain/rain2_off.png',
                    music: oss+'/image/rain/loudThunder.mp3',
                    active: false
                },
                {
                    on: oss+'/image/rain/rain3_on.png',
                    off: oss+'/image/rain/rain3_off.png',
                    music: oss+'/image/rain/rain.mp3',
                    active: false
                }
            ],
            loading: true,
    ...
    mounted(){
        let img = new Image();
        img.src = oss+'/image/rain/rain-bg.gif'
        img.onload = () => {
            this.loading = false
            this.img = img.src
			setTimeout(() => {
